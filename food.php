		...
		<div class="container-fluid">
			...
			<tr>
				...
				<td width="460">
					<p>&nbsp;</p>
					<p>&nbsp;</p>
					<center><h1 style = float="center"><b><u>Food</u></b></h1>
					<p>Here are some food supplies you might need</p>
					...
					<table border = "2" cellpadding="15" table id = "T1">
						...
						<?php
							...
							*/
							$inputs[0] = "*";
							$inputs[1] = "Products";
							$inputs[2] = "ProductCategories_ProdCatID = 1";// replace the contents of these quotes with a the contents of a where clause on the theme of prodCatID = 1, this is one of the things I couldn't make work.
...
/* 							for ($i=0; $i < 2; $i++){
							...
							if (empty($items) or $items == null){
								...
								foreach ($items['outValue'] as $i => $row){
									...
									//print("<p><a href=\"shoppingCart.php?add=""> Add to Cart </a></p>");	
									//print("<p><a href=\{$_SERVER['PHP_SELF']}?deleteitem={$line['cartID']}\"> Add to cart <a><p>");								
									print("</td></tr>");
								}
							}
						?>
