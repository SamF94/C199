		...
		<nav class= "navbar navbar-default">
			...
			<tr>
				...
				<td width="330">
					<p>&nbsp;</p>
					<p>&nbsp;</p>
					<center><h2><b><u> Pagan </u></b></h2>
					<p>Come get these if you want, you tree-hugging blasted heathen!</p>
					<table border = "2" cellpadding="15" table id = "T1">
						...
						<?php
							...
							*/
							$inputs[0] = "*";
							$inputs[1] = "Products";
							$inputs[2] = "ProductCategories_ProdCatID = 3";// replace the contents of these quotes with a the contents of a where clause on the theme of prodCatID = 1, this is one of the things I couldn't make work.
