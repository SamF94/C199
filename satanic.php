		...
		<nav class= "navbar navbar-default">
			...
			<tr>
				<td width="330">
					<p>&nbsp;</p>
					<p>&nbsp;</p>
					<center><h1><b><u> Satanic </u></b></h1>
					<p>For occasions when you want to scare your parents or going through an edgelord phase.</p>
					<table border = "2" cellpadding="15" table id = "T1">
						...
						<?php
							...
							*/
							$inputs[0] = "*";
							$inputs[1] = "Products";
							$inputs[2] = "ProductCategories_ProdCatID = 2";// replace the contents of these quotes with a the contents of a where clause on the theme of prodCatID = 1, this is one of the things I couldn't make work.
